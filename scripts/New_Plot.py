...
Energy = input("Enter the Energy in MeV you want to plot:")

#Energy = Energy[0]

csv_path = "~/CaloGAN/outputs/csv/"
files = ["CaloImg_X1_@"+Energy+"MeV.csv", "CaloImg_X2_@"+Energy+"MeV.csv", "CaloImg_X4_@"+Energy+"MeV.csv"]
#files = ["CaloImg_X4_@32500MeV.csv"]

for file in files:
    print("Processing file: ", file)
    data = pd.read_csv(csv_path+file, skiprows=2)
